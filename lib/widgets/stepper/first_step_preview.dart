        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              sizedBoxHeight(10),
              Text('Mitthi pianni leh thla', style: labelStyle()),
              Text(
                controller.dob.text,
                style: const TextStyle(fontWeight: FontWeight.bold),
              ),
              sizedBoxHeight(10),
              Text('Kum', style: labelStyle()),
              Text(
                controller.dob.text,
                style: const TextStyle(fontWeight: FontWeight.bold),
              ),
              ...
              sizedBoxHeight(10),
              Text('Thih ni leh darkar', style: labelStyle()),
              Text(
                controller.deathDateTime.text,
                style: const TextStyle(fontWeight: FontWeight.bold),
              ),
              sizedBoxHeight(10),
              Text('Thihna hmun', style: labelStyle()),
              Text(
              ...
              sizedBoxHeight(10),
              Text('Veng/Khua', style: labelStyle()),
              Text(
                controller.vengKhua.text,
                style: const TextStyle(fontWeight: FontWeight.bold),
              ),
              sizedBoxHeight(10),
              Text('Assembly Constituency', style: labelStyle()),
              Text(
