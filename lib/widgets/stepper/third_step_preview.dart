          ...
          child: Column(
            ...
            children: [
              ...
              const Row(
                ...
                children: [Text('Document thil tel te'), Text('5/5')],
              ),
              Container(height: 5, width: 20, color: Colors.black),
              Padding(
                  ...
                  children: [
                    Wrap(
                      children: [
                        ...
                        sizedBoxWidth(5),
                        const Text('Mitthi Aadhaar/Voter ID/Birth Certificate'),
                      ],
                    ),
                    sizedBoxHeight(10),
                    const Row(
                    ...
                    Row(
                      children: [
                        ...
                        const Text('Bank Passbook Front Page'),
                      ],
                    ),
                  ],
                ),
                ...
                children: [
                  Obx(
                    () => Checkbox(
                      ...
                      onChanged: (value) {
                        controller.declarationCheckBox.value = value ?? false;
                      },
                    ),
                  ),
                  Flexible(
